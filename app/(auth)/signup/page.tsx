...
export default function Signup() {
  return (
    <main className="min-h-screen flex items-center justify-center  p-6   m-auto">
      <section className="max-w-[1400px] w-full flex items-center gap-12 max-xl:flex-col-reverse">
        <article className="flex-1 text-lg leading-relaxed ">
        ...
        <div className="flex-[2] flex flex-col items-center gap-12  ">
          <div className="flex flex-col items-center gap-20 max-sm:gap-8 bg-muted px-12 max-lg:px-8 py-24 max-sm:py-12  rounded-2xl ">
          <h2 className="text-4xl font-semibold max-sm:text-3xl text-center">Choose an Account</h2>
